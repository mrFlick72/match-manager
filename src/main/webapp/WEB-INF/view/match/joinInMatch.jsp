...
<div class="row">
    <div id="search" class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
        <form name="searchMatch" action="searchMatch" method="post">
            <fieldset>
                <legend>Find a reserved match</legend>
                <div class="row component-container">
                    <div class="form-group">
                        <label for="date" class = "col-lg-1 col-md-1 col-sm-1 col-xs-1 control-label">Date:</label>
                ...
                <div class="row component-container">
                    <div class="form-group">
                        <label for="footballField" class = "col-lg-1 col-md-1 col-sm-1 col-xs-1 control-label">Campo:</label>
                        <div class = "col-lg-4 col-md-4 col-sm-4 col-xs-4">
                ...
                <div class="row component-container">
                    <div class="form-group">
                        <label for="hour" class="col-lg-1 col-md-1 col-sm-1 col-xs-1 control-label">Hour:</label>
                        <div class = "col-lg-4 col-md-4 col-sm-4 col-xs-4">
